...
public class UserLogin
{
    ...
    public async Task<LoginResult> DoLogin()
    {
        ...
        if (await SteamApi.MobileLoginRequest<RsaResponse>(ApiEndpoints.CommunityBase + "/login/getrsakey",
                SteamApi.RequestMethod.Post, postData, cookies) is not { } rsaResponse)
        ...
        if (await SteamApi.MobileLoginRequest<LoginResponse>(ApiEndpoints.CommunityBase + "/login/dologin",
