...
namespace WpfHelper.Custom
{
    partial class CustomMessageBoxWindow : Window
    {
        ...
        public CustomMessageBoxWindow(string text, string title, MessageBoxButton button, MessageBoxImage image) : this(text, title, button)
        {
            ...
            {
                MessageBoxImage.Warning => BitmapToBitmapImageConvertService.BitmapToBitmapImage(SystemIcons.Warning.ToBitmap()),
                MessageBoxImage.Error => BitmapToBitmapImageConvertService.BitmapToBitmapImage(SystemIcons.Hand.ToBitmap()),
                MessageBoxImage.Information => BitmapToBitmapImageConvertService.BitmapToBitmapImage(SystemIcons.Information.ToBitmap()),
                MessageBoxImage.Question => BitmapToBitmapImageConvertService.BitmapToBitmapImage(SystemIcons.Question.ToBitmap()),
